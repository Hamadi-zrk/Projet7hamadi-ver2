...
st.title("Projet 7 : Hamadi Zarrouk - 03_2022")
...
def example_ids():
    ...
    sample = df_final['SK_ID_CURR'].sample(10).tolist()
...
dashboard_page = ''
st.markdown('* Le dashbord **Global** présentent des informations générales sur la base de données utilisée.')
st.markdown("* le **Client** dashboard présentent la prrobabilités calculé par le modèle et les indicateurs d'interprtabilité locale.")
dashboard_page = st.selectbox('Merci de sélectionner un dashboard:', options = ['','Global Dashboard', 'Client Dashboard'])
if dashboard_page == '':
    pass
